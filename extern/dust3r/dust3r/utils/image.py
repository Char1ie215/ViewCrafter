...
def process_images_directly(img, size, square_ok=False,force_1024 = False):
        imgs = []
        if force_1024:
            img = center_crop_pil_image(img)
        img_ori = img
...
def process_two_images_directly(img1, img2, size, square_ok=False, force_1024=False):
    imgs = []
